    ...
    public partial class Migration_01 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OutletsId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutletStaff", x => new { x.OutletsId, x.StaffId });
                    table.ForeignKey(
                        name: "FK_OutletStaff_Outlets_OutletsId",
                        column: x => x.OutletsId,
                        principalTable: "Outlets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OutletStaff_Staff_StaffId",
                        column: x => x.StaffId,
